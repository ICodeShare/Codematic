...
namespace Maticsoft.BuilderDALELSQL
{
	public class BuilderDAL : IBuilderDAL
	{
		...
		public Hashtable Languagelist
		{
			get
			{
				return Language.LoadFromCfg("BuilderDALELSQL.lan");
			}
		}
		...
		public string CreatExists()
		{
			...
			if (this._keys.Count > 0)
			{
				...
				stringPlus.AppendSpaceLine(3, "strSql.Append(\" where " + CodeCommon.GetWhereExpression(this.Keys, false) + "\");");
				stringPlus.AppendSpaceLine(3, "Database db = DatabaseFactory.CreateDatabase();");
				stringPlus.AppendSpaceLine(3, "DbCommand dbCommand = db.GetSqlStringCommand(strSql.ToString());");
				stringPlus.AppendSpaceLine(3, "int cmdresult;");
				stringPlus.AppendSpaceLine(3, "object obj = db.ExecuteScalar(dbCommand);");
				stringPlus.AppendSpaceLine(3, "if ((Object.Equals(obj, null)) || (Object.Equals(obj, System.DBNull.Value)))");
				stringPlus.AppendSpaceLine(3, "{");
				stringPlus.AppendSpaceLine(4, "cmdresult = 0;");
				stringPlus.AppendSpaceLine(3, "}");
				stringPlus.AppendSpaceLine(3, "else");
				stringPlus.AppendSpaceLine(3, "{");
				stringPlus.AppendSpaceLine(4, "cmdresult = int.Parse(obj.ToString());");
				stringPlus.AppendSpaceLine(3, "}");
				stringPlus.AppendSpaceLine(3, "if (cmdresult == 0)");
				stringPlus.AppendSpaceLine(3, "{");
		...
		public string CreatAdd()
		{
			...
			foreach (ColumnInfo current in this.Fieldlist)
			{
				...
				if (!current.IsIdentity)
				{
					...
					{
						stringPlus3.AppendSpaceLine(3, "strSql.Append(\"'\"+model." + columnName + "+\"',\");");
					}
					else
					{
						stringPlus3.AppendSpaceLine(3, "strSql.Append(\"\"+model." + columnName + "+\",\");");
			...
			stringPlus3.Remove(stringPlus3.Value.Length - 6, 1);
			stringPlus2.AppendLine("\");");
			stringPlus.Append(stringPlus2.ToString());
			stringPlus.AppendSpaceLine(3, "strSql.Append(\")\");");
			stringPlus.AppendSpaceLine(3, "strSql.Append(\" values (\");");
			stringPlus.Append(stringPlus3.ToString());
			stringPlus.AppendSpaceLine(3, "strSql.Append(\")\");");
			if ((this.dbobj.DbType == "SQL2000" || this.dbobj.DbType == "SQL2005" || this.dbobj.DbType == "SQL2008" || this.dbobj.DbType == "SQL2012") && this.IsHasIdentity)
			{
				...
				stringPlus.AppendSpaceLine(3, "object obj = db.ExecuteScalar(dbCommand);");
				stringPlus.AppendSpaceLine(3, "if(!int.TryParse(obj.ToString(),out result))");
				stringPlus.AppendSpaceLine(3, "{");
				stringPlus.AppendSpaceLine(4, "return 0;");
				stringPlus.AppendSpaceLine(3, "}");
				stringPlus.AppendSpaceLine(3, "return result;");
			}
			else
			{
				stringPlus.AppendSpaceLine(3, "DbCommand dbCommand = db.GetSqlStringCommand(strSql.ToString());");
		...
		public string CreatUpdate()
		{
			...
			foreach (ColumnInfo current in this.Fieldlist)
			{
				string columnName = current.ColumnName;
				string typeName = current.TypeName;
				string arg_E2_0 = current.Length;
				bool arg_E9_0 = current.IsIdentity;
				bool arg_F0_0 = current.IsPrimaryKey;
			...
			stringPlus.Remove(stringPlus.Value.Length - 6, 1);
			stringPlus.AppendSpaceLine(3, "strSql.Append(\" where " + CodeCommon.GetModelWhereExpression(this.Keys, true) + "\");");
			stringPlus.AppendSpaceLine(3, "DbCommand dbCommand = db.GetSqlStringCommand(strSql.ToString());");
			stringPlus.AppendSpaceLine(3, "db.ExecuteNonQuery(dbCommand);");
			stringPlus.AppendSpace(2, "}");
			return stringPlus.ToString();
		...
		public string CreatDelete()
		{
			...
			stringPlus.AppendSpaceLine(3, "strSql.Append(\" where " + CodeCommon.GetWhereExpression(this.Keys, true) + "\" );");
			stringPlus.AppendSpaceLine(3, "DbCommand dbCommand = db.GetSqlStringCommand(strSql.ToString());");
		...
		public string CreatGetModel()
		{
			...
			stringPlus.AppendSpaceLine(3, "strSql.Append(\" from " + this._tablename + " \");");
			stringPlus.AppendSpaceLine(3, "strSql.Append(\" where " + CodeCommon.GetWhereExpression(this.Keys, true) + "\" );");
			stringPlus.AppendSpaceLine(3, "Database db = DatabaseFactory.CreateDatabase();");
			stringPlus.AppendSpaceLine(3, "DbCommand dbCommand = db.GetSqlStringCommand(strSql.ToString());");
		...
		public string CreatGetListByPageProc()
		{
			...
			stringPlus.AppendSpaceLine(3, "db.AddInParameter(dbCommand, \"fldName\", DbType.AnsiString, \"" + this._keys + "\");");
