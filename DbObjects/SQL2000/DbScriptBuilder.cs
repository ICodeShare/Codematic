...
namespace Maticsoft.DbObjects.SQL2000
{
	public class DbScriptBuilder : IDbScriptBuilder
	{
			...
			if (this._keys.Count > 0)
			{
				foreach (ColumnInfo current in this._keys)
				{
					if (CodeCommon.DbTypeToCS(current.TypeName) == "int")
					{
						...
						{
							stringPlus.Append("if exists (select * from dbo.sysobjects where id = object_id(N'[dbo].[");
							stringPlus.Append(this.ProcPrefix + this._tablename + "_GetMaxId");
							stringPlus.AppendLine("]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)");
							stringPlus.AppendLine("drop procedure [dbo].[" + this.ProcPrefix + this._tablename + "_GetMaxId]");
		...
		public string CreatPROCIsHas()
		{
			...
			stringPlus.AppendLine("]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)");
			stringPlus.AppendLine("drop procedure [dbo].[" + this.ProcPrefix + this._tablename + "_Exists]");
			stringPlus.AppendLine("GO");
			stringPlus.AppendLine("------------------------------------");
		...
		public string CreatPROCADD()
		{
			...
			stringPlus.AppendLine("]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)");
			stringPlus.AppendLine("drop procedure [dbo].[" + this.ProcPrefix + this._tablename + "_ADD]");
			stringPlus.AppendLine("GO");
			stringPlus.AppendLine("------------------------------------");
		...
		public string CreatPROCUpdate()
		{
			...
			stringPlus.AppendLine("]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)");
			stringPlus.AppendLine("drop procedure [dbo].[" + this.ProcPrefix + this._tablename + "_Update]");
			stringPlus.AppendLine("GO");
			stringPlus.AppendLine("------------------------------------");
		...
		public string CreatPROCDelete()
		{
			...
			stringPlus.AppendLine("]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)");
			stringPlus.AppendLine("drop procedure [dbo].[" + this.ProcPrefix + this._tablename + "_Delete]");
			stringPlus.AppendLine("GO");
			stringPlus.AppendLine("------------------------------------");
		...
		public string CreatPROCGetModel()
		{
			...
			stringPlus.AppendLine("]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)");
			stringPlus.AppendLine("drop procedure [dbo].[" + this.ProcPrefix + this._tablename + "_GetModel]");
			stringPlus.AppendLine("GO");
			stringPlus.AppendLine("------------------------------------");
		...
		public string CreatPROCGetList()
		{
			...
			stringPlus.AppendLine("]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)");
			stringPlus.AppendLine("drop procedure [dbo].[" + this.ProcPrefix + this._tablename + "_GetList]");
			stringPlus.AppendLine("GO");
			stringPlus.AppendLine("------------------------------------");
		...
		public string GetSQLSelect(string dbname, string tablename)
		{
			...
			stringPlus.AppendLine(" FROM [" + tablename + "]");
			return stringPlus.Value;
		}
		public string GetSQLUpdate(string dbname, string tablename)
		{
			...
			stringPlus.AppendLine(" WHERE <自定义搜索条件>");
			return stringPlus.Value;
		}
		...
		public string GetSQLInsert(string dbname, string tablename)
		{
			...
			stringPlus.AppendLine(") VALUES (" + stringPlus2.Value + ")");
			return stringPlus.Value;
		}
	}
}
